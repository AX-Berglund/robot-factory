...
{
	private static final Logger LOGGER = Logger.getLogger(CapacityScalingMinimumCostFlow.class.getName());
    ...
    private void pushDijkstra(Node start, Set<Node> negativeExcessNodes, int delta)
    {
        ...
        while (!heap.isEmpty()) {
            ...
            currentNode.labelType = permanentlyLabeledType; // currentNode becomes permanently
                                                            // labeled
