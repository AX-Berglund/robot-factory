    ...
    extends MaximumFlowAlgorithmBase<V, E>
{
    ...
    private class PushRelabelDiagnostic
    {
    	...
    	private static final Logger LOGGER = Logger.getLogger(PushRelabelDiagnostic.class.getName());
        ...
        void dump()
        {
            ...
            LOGGER.info("RELABELS    ");
            LOGGER.info("--------    ");
            LOGGER.info("    Count:  " + relabelsCounter);
            LOGGER.info("            " + relabelsSorted);
            ...
            LOGGER.info("----------  ");
            LOGGER.info("    Count:  " + dischargesCounter);
            LOGGER.info("            " + dischargesSorted);
        }
    }
